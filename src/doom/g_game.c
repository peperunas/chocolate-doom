...
static int *weapon_keys[] = {&key_weapon1,
                             &key_weapon2,
                             &key_weapon3,
                             &key_weapon4,
                             &key_weapon5,
...
void G_InitNew(skill_t skill, int episode, int map) {
  ...
  */
  ...
  if (gamemode == commercial) {
    ...
    switch (gameepisode) {
    default:
    case 1: skytexturename = "SKY1"; break;
    case 2: skytexturename = "SKY2"; break;
    case 3: skytexturename = "SKY3"; break;
...
static const char *DemoVersionDescription(int version) {
  ...
  case 111: return "v1.91 hack demo?";
  default: break;
  }
...
void G_DoPlayDemo(void) {
  ...
  if (D_NonVanillaPlayback(demoversion == DOOM_191_VERSION,
                           lumpnum,
