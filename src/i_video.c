...
static void HandleWindowEvent(SDL_WindowEvent *event) {
  ...
  switch (event->event) {
        ...
        case SDL_ACTIVEEVENT:
            ...
            break;
#endif
  case SDL_WINDOWEVENT_EXPOSED: palette_to_set = true; break;
  ...
  case SDL_WINDOWEVENT_MINIMIZED: screenvisible = false; break;
...
void I_GetEvent(void) {
  ...
  while (SDL_PollEvent(&sdlevent)) {
    ...
    case SDL_KEYUP: I_HandleKeyboardEvent(&sdlevent); break;
...
static void SetVideoMode(void) {
  ...
  if (argbbuffer == NULL) {
    SDL_PixelFormatEnumToMasks(pixel_format,
                               &bpp,
                               &rmask,
                               &gmask,
                               &bmask,
