    ...
    if (cheating || (lines[i].flags & ML_MAPPED)) {
      ...
      if (!lines[i].backsector) {
        ...
        } else if (lines[i].flags & ML_SECRET) // secret door
        {
          ...
          case 26:
          case 32: AM_drawMline(&l, BLUEKEY); break;
          case 27:
          case 34: AM_drawMline(&l, YELLOWKEY); break;
          case 28:
          case 33: AM_drawMline(&l, GREENKEY); break;
          default: break;
          }
...
void AM_drawkeys(void) {
  if (KeyPoints[0].x != 0 || KeyPoints[0].y != 0) {
    AM_drawLineCharacter(keysquare,
                         NUMKEYSQUARELINES,
                         0,
                         0,
                         YELLOWKEY,
