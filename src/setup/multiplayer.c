...
static const char *chex_skills[] = {"Easy does it",
                                    "Not so sticky",
                                    "Gobs of goo",
                                    "Extreme ooze",
                                    "SUPER SLIMEY!"};

static const char *heretic_skills[] = {"Thou needeth a wet-nurse",
                                       "Yellowbellies-R-us",
                                       "Bringest them oneth",
                                       "Thou art a smite-meister",
                                       "Black plague possesses thee"};

static const char *hexen_fighter_skills[] = {"Squire",
                                             "Knight",
                                             "Warrior",
                                             "Berserker",
                                             "Titan"};

static const char *hexen_cleric_skills[] = {"Altar boy",
                                            "Acolyte",
                                            "Priest",
                                            "Cardinal",
                                            "Pope"};

static const char *hexen_mage_skills[] = {"Apprentice",
                                          "Enchanter",
                                          "Sorceror",
                                          "Warlock",
                                          "Archimage"};

static const char *strife_skills[] = {"Training",
                                      "Rookie",
                                      "Veteran",
                                      "Elite",
                                      "Bloodbath"};
...
static const char *gamemodes[] = {"Co-operative",
                                  "Deathmatch",
                                  "Deathmatch 2.0"};
...
static void UpdateSkillButton(void) {
  ...
  if (IsChexQuest(iwad)) {
    ...
    switch (gamemission) {
    default:
    case doom: skillbutton->values = doom_skills; break;

    case heretic: skillbutton->values = heretic_skills; break;
    ...
    case strife: skillbutton->values = strife_skills; break;
    }
}
...
static void QueryResponseCallback(net_addr_t *     addr,
  ...
  if (querydata->num_players > 0) {
    M_snprintf(description,
               sizeof(description),
               "(%d/%d) ",
               querydata->num_players,
               querydata->max_players);
  } else {
