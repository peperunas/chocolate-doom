  ...
  case 1: // UP
    ...
    if (res == RES_PASTDEST) {
      ...
      case CLEV_CRUSHANDRAISE:
        ...
        break;
      default: P_RemoveActiveCeiling(ceiling); break;
      }
    }
    break;
  case -1: // DOWN
  ...
  */
  while ((secnum = P_FindSectorFromTag(arg[0], secnum)) >= 0) {
    ...
    case CLEV_CRUSHRAISEANDSTAY:
      ...
      ceiling->direction    = -1;
      break;
    case CLEV_CRUSHANDRAISE: ceiling->topheight = sec->ceilingheight;
    case CLEV_LOWERANDCRUSH: ceiling->crush = arg[2]; // arg[2] = crushing value
