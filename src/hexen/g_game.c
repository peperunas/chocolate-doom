...
fixed_t forwardmove[NUMCLASSES][2] = {{0x1D, 0x3C},
                                      {0x19, 0x32},
                                      {0x16, 0x2E},
                                      {0x18, 0x31}};

fixed_t sidemove[NUMCLASSES][2] = {{0x1B, 0x3B},
                                   {0x18, 0x28},
                                   {0x15, 0x25},
                                   {0x17, 0x27}};
...
void G_Ticker(void) {
  ...
  while (gameaction != ga_nothing) {
    ...
    case ga_initnew: G_DoInitNew(); break;
    ...
    case ga_savegame:
      ...
      G_DoSaveGame();
      break;
    case ga_singlereborn: G_DoSingleReborn(); break;
...
//
  ...
  case GS_DEMOSCREEN: H2_PageTicker(); break;
  }
}
...
void G_RecordDemo(skill_t     skill,
                  int         numplayers,
                  int         episode,
                  int         map,
                  const char *name) {
