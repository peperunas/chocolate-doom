...
int PStateRun[NUMCLASSES] = {S_FPLAY_RUN1,
                             S_CPLAY_RUN1,
                             S_MPLAY_RUN1,
                             S_PIGPLAY_RUN1};

int PStateAttack[NUMCLASSES] = {S_FPLAY_ATK1,
                                S_CPLAY_ATK1,
                                S_MPLAY_ATK1,
                                S_PIGPLAY_ATK1};

int PStateAttackEnd[NUMCLASSES] = {S_FPLAY_ATK2,
                                   S_CPLAY_ATK3,
                                   S_MPLAY_ATK2,
                                   S_PIGPLAY_ATK1};
...
boolean P_UndoPlayerMorph(player_t *player) {
  ...
  case PCLASS_FIGHTER: mo = P_SpawnMobj(x, y, z, MT_PLAYER_FIGHTER); break;
  case PCLASS_CLERIC: mo = P_SpawnMobj(x, y, z, MT_PLAYER_CLERIC); break;
  case PCLASS_MAGE: mo = P_SpawnMobj(x, y, z, MT_PLAYER_MAGE); break;
  default:
...
void P_BlastMobj(mobj_t *source, mobj_t *victim, fixed_t strength) {
  ...
  } else // full strength blast from artifact
  {
    if (victim->flags & MF_MISSILE) {
      ...
      case MT_SORCBALL2:
      case MT_SORCBALL3: return; break;
...
boolean P_UseArtifact(player_t *player, artitype_t arti) {
  ...
  case arti_summon:
    ...
    break;
  case arti_teleport: P_ArtiTele(player); break;
  case arti_teleportother: P_ArtiTeleportOther(player); break;
  case arti_poisonbag:
  ...
  case arti_boostarmor:
    ...
    break;
  case arti_blastradius: P_BlastRadius(player); break;
