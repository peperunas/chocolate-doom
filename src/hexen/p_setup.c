...
static const char *MapCmdNames[] = {"SKY1",
                                    "SKY2",
                                    "DOUBLESKY",
                                    "LIGHTNING",
                                    "FADETABLE",
                                    ...
                                    "CD_TITLE_TRACK",
                                    NULL};
static int         MapCmdIDs[]   = {MCMD_SKY1,
                          MCMD_SKY2,
                          MCMD_DOUBLESKY,
                          MCMD_LIGHTNING,
                          MCMD_FADETABLE,
  ...
  while (SC_GetString()) {
    ...
    while (SC_GetString()) {
      ...
      case MCMD_SKY2:
        ...
        break;
      case MCMD_DOUBLESKY: info->doubleSky = true; break;
      case MCMD_LIGHTNING: info->lightning = true; break;
      case MCMD_FADETABLE:
        SC_MustGetString();
...
void InitMapMusicInfo(void) {
  ...
  for (i = 0; i < 99; i++) {
    M_StringCopy(MapInfo[i].songLump,
                 DEFAULT_SONG_LUMP,
